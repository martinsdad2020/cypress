describe("filter", function() {
     ...
     it('filter', function() {
      ...
      cy.get('._1R8- > :nth-child(1)').contains('Амортизатор задний Dodge').should('be.visible');
      ...
      cy.get('._444m').contains('Амортизатор задний Dodge').should('be.visible');
      cy.get('.hmqi').contains('Все').click();
      cy.get('.En5g > .NXKZ > ._3hEL').click();
      cy.get('._3Sgn').contains('По возрастанию цены').click();
      cy.get('._444m').contains('Переключатель отопителя Dodge Caravan IV 2001 - 2007').should('be.visible');
      cy.get('.En5g > .NXKZ > ._3hEL').click();
      ...
      cy.get('._444m').contains('Подушка безопасности в рулевое колесо Dodge Intrepid 1998 - 2004').should('be.visible');
      cy.get('.En5g > .NXKZ > ._3hEL').click();
      cy.get('._3Sgn').contains('По умолчанию').click();
      cy.get('._444m').contains('Амортизатор задний Dodge').should('be.visible');
      cy.get('._2dgX > .NXKZ > ._3hEL').click();
      cy.get('._3Sgn').contains('Москва').click();
      cy.get('._444m').contains('Крыло переднее правое Dodge Journey c 2009 г.').should('be.visible');
      cy.get('._2dgX > .NXKZ > ._3hEL').click();
      cy.get('._3Sgn').contains('Санкт-Петербург').click();
      cy.get('._444m').contains('Амортизатор задний Dodge').should('be.visible');
      cy.get('._2dgX > .NXKZ > ._3hEL').click();
      cy.get('._3Sgn').contains('Минск').click();
      cy.get('._444m').contains('Моторчик отопителя Dodge Nitro 2007 - 2011').should('be.visible');
      cy.get('._2dgX > .NXKZ > ._3hEL').click();
      ...
      cy.get('._3Jvj > :nth-child(3)').click();
});
});
