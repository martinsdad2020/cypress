describe("filter", function () {
     ...
     it('filter', function () {
          ...
          cy.get('#root').contains('Maybach').click();
          cy.get(':nth-child(1) > ._2DovX').contains('Накладка стекла переднего правого Maybach').should('be.visible');
          cy.get('.FQzr2').contains('Б/У').click();
          cy.wait(1000);
          cy.get(':nth-child(1) > ._2DovX').contains('Накладка стекла переднего правого Maybach').should('be.visible');
          cy.get('.FQzr2').contains('Новые').click();
          cy.wait(1000);
          cy.get('._1-LbT').contains('Детали не найдены').should('be.visible');
          cy.get('.FQzr2').contains('Все').click();
          cy.get('.dFQW3 > ._20KFe > .fqKS8').click();
          cy.get('._1xJW6').contains('По возрастанию цены').click();
          cy.wait(1000);
          cy.get(':nth-child(1) > ._2DovX').contains('Крышка расширительного бачка Maybach').should('be.visible');
          cy.get('.dFQW3 > ._20KFe > .fqKS8').click();
          cy.get('._1xJW6').contains('По убыванию цены').click();
          cy.wait(1000);
          cy.get(':nth-child(1) > ._2DovX').contains('Крыло переднее левое Maybach').should('be.visible');
          cy.get('.dFQW3 > ._20KFe > .fqKS8').click();
          cy.get('._1xJW6').contains('Сначала новые').click();
          cy.wait(1000);
          cy.get(':nth-child(1) > ._2DovX').contains('Накладка двери задней правой Maybach').should('be.visible');
          cy.get('.dFQW3 > ._20KFe > .fqKS8').click();
